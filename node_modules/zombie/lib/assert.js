...
module.exports = (function () {
  ...
  _createClass(Assert, [{
    ...
    value: function attribute(selector, name) {
      ...
      try {
        for (var _iterator = _core.getIterator(elements), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    value: (function (_elements) {
      function elements(_x, _x2, _x3) {
        return _elements.apply(this, arguments);
      }
      ...
      return elements;
    })(function (selector, count, message) {
      var elements = this.browser.queryAll(selector);
      if (arguments.length === 1) this.elements(selector, { atLeast: 1 });else if (_core.Number.isInteger(count)) this.elements(selector, { exactly: count }, message);else {
        if (_core.Number.isInteger(count.exactly)) assert.equal(elements.length, count.exactly, message || 'Expected ' + count.exactly + ' elements matching "' + selector + '", found ' + elements.length);
        if (_core.Number.isInteger(count.atLeast)) assert(elements.length >= count.atLeast, message || 'Expected at least ' + count.atLeast + ' elements matching "' + selector + '", found only ' + elements.length);
        if (_core.Number.isInteger(count.atMost)) assert(elements.length <= count.atMost, message || 'Expected at most ' + count.atMost + ' elements matching "' + selector + '", found ' + elements.length);
      }
    })
  }, {
    key: 'hasClass',
    ...
    value: function hasClass(selector, expected, message) {
      ...
      try {
        for (var _iterator2 = _core.getIterator(elements), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function hasNoClass(selector, expected, message) {
      ...
      try {
        for (var _iterator3 = _core.getIterator(elements), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
    ...
    value: function className(selector, expected, message) {
      ...
      try {
        for (var _iterator4 = _core.getIterator(elements), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
    ...
    value: (function (_style) {
      ...
      try {
        for (var _iterator5 = _core.getIterator(elements), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
    ...
    value: function input(selector) {
      ...
      try {
        for (var _iterator6 = _core.getIterator(elements), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
