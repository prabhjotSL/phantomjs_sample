...
function setupWindow(window, args) {
  ...
  // Access to browser
  _core.Object.defineProperty(window, 'browser', {
    value: browser,
    enumerable: true
  });
  ...
  _core.Object.defineProperty(window, 'cookies', {
    get: function get() {
  ...
  _core.Object.defineProperty(window, '_eventQueue', {
    value: eventQueue
  });
  ...
  _core.Object.defineProperty(window, 'closed', {
    get: function get() {
      return closed;
    },
    enumerable: true
  ...
  var windowHistory = {
    ...
    pushState: function pushState() {
      for (var _len = arguments.length, stateArgs = Array(_len), _key = 0; _key < _len; _key++) {
        stateArgs[_key] = arguments[_key];
      }

      history.pushState.apply(history, stateArgs);
    },
    replaceState: function replaceState() {
      for (var _len2 = arguments.length, stateArgs = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        stateArgs[_key2] = arguments[_key2];
      }

      history.replaceState.apply(history, stateArgs);
    },
    dump: function dump(output) {
      history.dump(output);
    }
  };
  _core.Object.defineProperties(windowHistory, {
    length: {
      get: function get() {
  ...
  _core.Object.defineProperty(window, 'location', {
    get: function get() {
...
function getHTMLFromResponseBody(buffer, contentType) {
  ...
  if (mimeType) {
    ...
    try {
      for (var _iterator = _core.getIterator(typeOptions), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var typeOption = _step.value;
