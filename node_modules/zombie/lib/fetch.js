  ...
  _createClass(Body, [{
    ...
    value: function arrayBuffer() {
      ...
      return this._consume().then(function (buffer) {
        ...
        var arrayBuffer = new Uint8Array(_this.body.length);
        for (var i = 0; i < _this.body.length; ++i) {
          arrayBuffer[i] = _this.body[i];
        }return arrayBuffer;
      });
    }
  }, {
    ...
    value: function formData() {
      ...
      return this._consume().then(function (buffer) {
        ...
        var contentType = _this2.headers.get('Content-Type') || '';
    ...
    value: function json() {
      ...
      return this._consume().then(function (buffer) {
        _this3.body = buffer.toString('utf-8');
      }).then(function () {
        return JSON.parse(_this3.body);
      });
    }
  }, {
    key: 'text',
