    ...
    value: function makeHTTPRequest(browser, request) {
      ...
      if (protocol === 'file:') {
        ...
        if (request.method !== 'GET') {
          return new Fetch.Response('', { url: url, status: 405 });
        ...
        if (exists) {
          ...
          return new Fetch.Response('', { url: url, status: 404 });
        }
      }
      ...
      var consumeBody = /^POST|PUT/.test(request.method) && request._consume() || _core.Promise.resolve(null);
          ...
          httpRequest.on('response', function (response) {
            ...
            var arrayOfHeaders = _.reduce(response.headers, function (headers, value, name) {
              if (isArray(value)) {
                ...
                try {
                  for (var _iterator2 = _core.getIterator(value), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
